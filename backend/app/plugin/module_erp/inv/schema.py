...
class ErpCreateSchema(BaseModel):
    """新增模型"""
...
class ErpUpdateSchema(BaseModel):
    """更新模型"""
...
class ErpOutSchema(ErpCreateSchema, BaseSchema, UserBySchema):
    """响应模型"""

    model_config = ConfigDict(from_attributes=True)


class ErpQueryParam(BaseQueryParam, UserByQueryParam):
